...
class TrainData(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # box_coordinates = anno.get('box_examples_coordinates', {})  # Get the bounding box coordinate information of the image
        # # print(box_coordinates)
        # # Get the list of bounding boxes for the first category
