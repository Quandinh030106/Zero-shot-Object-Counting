...
class TrainData(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Assume each image ID has a corresponding entry in negative sample annotations
        neg_anno = self.neg_annotations[im_id]  # Assume each image ID has a corresponding entry in negative sample annotations
